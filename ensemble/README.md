...
.venv/bin/python -m pytest tests/unit/test_gate.py tests/unit/test_gate_edges.py \
  ...
  tests/unit/test_reasoning_is_readable.py tests/unit/test_env.py tests/unit/test_explain.py \
...
118 tests. Everything passes offline against the fake provider. **No API key is needed for any test.**
